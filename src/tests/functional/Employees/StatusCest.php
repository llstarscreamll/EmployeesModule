...
class StatusCest
{
    ...
    public function toggleStatus(FunctionalTester $I)
    {
        ...
        $I->see('S1 Empleado 1', 'tbody tr:first-child td'); // el último trabajador
        $I->see('Activado', 'tbody tr:nth-child(8) td span.text-success');
        ...
        $I->dontSee('S1 Empleado 1', 'select optgroup option');
